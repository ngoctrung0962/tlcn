    ...
    return isLoading ? (
        ...
        <div className="learn" style={{height: "100vh", overflow: "auto"}}>
          ...
          <span className="d-flex justify-content-between align-items-center">
            ...
            {activeLecture && (
                <div
                    className="row footer__tool d-flex flex-row justify-content-center align-items-center fixed-bottom">
                    <div
                        className="tool__container d-flex flex-row justify-content-center align-items-center gap-4 my-2">
